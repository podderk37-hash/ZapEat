...
function CheckOut() {
  ...
  return (
    <div className='min-h-screen bg-[#fff9f9] flex items-center justify-center p-6'>
      ...
      <div className='w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6'>
        ...
        <section>
          <h2 className='text-lg font-semibold mb-2 flex items-center gap-2 text-gray-800'>
            <FaLocationDot className='text-[#ff4d2d]' />Delivery Location</h2>
          <div className='flex gap-2 mb-3'>
            ...
            <button className='bg-[#ff4d2d] hover:bg-[#e64526] text-white px-3 py-2 rounded-lg 
               flex items-center justify-center' onClick={getLatLngByAddress}>
              <IoSearchSharp size={17} />
            </button>
            <button className='bg-blue-500 hover:bg-blue-600  text-white px-3 py-2 rounded-lg 
               flex items-center justify-center' onClick={getCurrentLocation}>
        ...
        <section>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            <div className={`flex items-center gap-3 rounded-xl border p-4 text-left transition ${paymentMethod === "cod"
              ? "border-[#ff4d2d] bg-orange-100 shadow" : "border-gray-200 hover:border-gray-300"
        ...
        <button className='w-full bg-[#ff4d2d] cursor-pointer hover:bg-[#e64526] text-white py-3 rounded-xl font-semibold'
