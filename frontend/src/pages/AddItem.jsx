...
function AddItem() {
    ...
    return (
     ...
     from-orange-500 relative to-white min-h-screen'>

            <div className='absolute top-[20px] left-[20px] z-[10] mb-[10px]' onClick={() => navigate("/")}>
                <IoMdArrowRoundBack size={35} className='text-[#2D2D2D]' />
            </div>
            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border-orange-100'>
                ...
                <form className='space-y-5' onSubmit={handleSubmit}>
                    <div>
                        ...
                        <input type="text" placeholder='Enter Food Name' className='w-full px-4 py-2 border rounded-lg 
          ...
          focus:ring-2 focus:outline-none focus:ring-orange-500' onChange={handleImage} />
                        {frontendImage &&
                            <div className='mt-4'>
          ...
          hover:bg-orange-600 hover:shadow-lg transition-all duratiion-200 cursor-pointer' disabled={loading}>
