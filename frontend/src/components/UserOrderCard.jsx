        ...
        <div className='bg-white rounded-lg shadow p-4 space-y-4'>
            <div className='flex justify-between border-b pb-2'>
                ...
                <div className='text-right'>
                    ...
                    </p> : <p className='font-medium text-gray-600'>
            ...
            <div className='flex justify-between items-center border-t pt-2'>
                ...
                <button className='bg-[#ff4d2d] cursor-pointer hover:bg-[#e64526] text-white px-4 py-2 rounded-lg
                 text-sm' onClick={() => navigate(`/track-order/${data._id}`)}>Track Order</button>
            </div>
