    ...
    <div className='w-full min-h-screen bg-[#fff9f6] flex flex-col items-center'>
        ...
        <div className='flex justify-center items-center p-4 sm:p-6'>
         ...
         hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              ...
              <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>Add your Restaurent</h2>
              ...
              <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md
               hover:bg-orange-600 transition-colors duration-200 cursor-pointer' onClick={() => navigate("/create-edit-shop")}>Get Started</button>
            </div>
          </div>
        </div>
      }
      ...
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6'>
          ...
          <div className='bg-white shadow-lg rounded-xl overflow-hidden border-orange-100 hover:shadow-2xl 
         ...
         hover:shadow-xl transition-shadow duration-300'>
              <div className='flex flex-col items-center text-center'>
                ...
                <p className='text-gray-600 mb-4 text-sm sm:text-base'>Share your delicious creations with our customers by adding them to menu.</p>
                <button className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md
               hover:bg-orange-600 transition-colors duration-200 cursor-pointer' onClick={() => navigate("/add-item")}>Add Food</button>
              </div>
