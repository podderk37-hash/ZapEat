  ...
  return (
    <div className='w-screen min-h-screen bg-[#fff9f6] flex flex-col gap-5 items-center overflow-y-auto'>
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        <div className='w-full relative'>
          {showLeftCateButton && <button className='absolute left-0 top-1/2 -translate-y-1/2 bg-[#ff4d2d] text-white p-2 rounded-full
           shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(cateScrollRef, "left")}>
            <FaCircleChevronLeft />
          </button>
          }
          ...
          {showRightCateButton && <button className='absolute right-0 top-1/2 -translate-y-1/2 bg-[#ff4d2d] text-white p-2 rounded-full
           shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(cateScrollRef, "right")}>
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        <div className='w-full relative'>
          {showLeftShopButton && <button className='absolute left-0 top-1/2 -translate-y-1/2 bg-[#ff4d2d] text-white p-2 rounded-full
           shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(shopScrollRef, "left")}>
            <FaCircleChevronLeft />
          </button>
          }
          ...
          <div
            className="w-full flex flex-wrap gap-4 pb-2 sm:flex-nowrap sm:overflow-x-auto"
            ref={shopScrollRef}>
            ...
            {shopInMyCity && shopInMyCity.length > 0 ? (
              ...
              [1, 2, 3, 4].map((_, index) => <FoodCardSkeleton key={index} type="shop" />)
            )}
          </div>


          {showRightShopButton && <button className='absolute right-0 top-1/2 -translate-y-1/2 bg-[#ff4d2d] text-white p-2 rounded-full
           shadow-lg hover:bg-[#e64528] z-10' onClick={() => scrollHandler(shopScrollRef, "right")}>
            <FaChevronCircleRight />
          </button>
          }
      ...
      <div className='w-full max-w-6xl flex flex-col gap-5 items-start p-[10px]'>
        ...
        {/* <div className='w-full flex flex-wrap gap-[20px] h-auto justify-center'>
